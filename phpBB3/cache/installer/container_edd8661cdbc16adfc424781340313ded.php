...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000005cc5f30f00000000217f933f(
...
class phpbbtemplatetwiglexer_000000005cc5f30f00000000217f933f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder6177394d530cd892085130 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6177394d530db955162632 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties6177394d53081555649428 = array(
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, 'set_environment', array('env' => $env), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        return $this->valueHolder6177394d530cd892085130->set_environment($env);
    }
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        return $this->valueHolder6177394d530cd892085130->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        return $this->valueHolder6177394d530cd892085130->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer6177394d530db955162632 = $initializer;
    }
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__get', array('name' => $name), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        if (isset(self::$publicProperties6177394d53081555649428[$name])) {
            return $this->valueHolder6177394d530cd892085130->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder6177394d530cd892085130;
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__isset', array('name' => $name), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__unset', array('name' => $name), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;
    ...
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__clone', array(), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        $this->valueHolder6177394d530cd892085130 = clone $this->valueHolder6177394d530cd892085130;
    }

    public function __sleep()
    {
        $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, '__sleep', array(), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;

        return array('valueHolder6177394d530cd892085130');
    }
    ...
    {
        return $this->initializer6177394d530db955162632;
    }
    ...
    {
        return $this->initializer6177394d530db955162632 && ($this->initializer6177394d530db955162632->__invoke($valueHolder6177394d530cd892085130, $this, 'initializeProxy', array(), $this->initializer6177394d530db955162632) || 1) && $this->valueHolder6177394d530cd892085130 = $valueHolder6177394d530cd892085130;
    }
    ...
    {
        return null !== $this->valueHolder6177394d530cd892085130;
    }
    ...
    {
        return $this->valueHolder6177394d530cd892085130;
    }
